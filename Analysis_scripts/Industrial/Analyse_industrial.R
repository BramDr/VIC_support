...
fit.file = "Input/country_industrial_global_fitting.csv"
fit.out = "Output/country_industrial_global.csv"
...
print(length(unique(c.subregion)))
print(length(unique(c.region)))
print(length(unique(c.global)))
