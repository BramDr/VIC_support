...
# Input
coef.file = "Input/country_industrial_global.csv"
gdp.file = "Input/country_GDP_interpolated_global.csv"
gva.file = "Input/country_GVA_interpolated_global.csv"
light.file = "Input/light_6min_global.RDS"
country.file = "Input/country_6min_global.RDS"
ind.tmp = "Saves/industrial_demand_global_tmp.RDS"
years = 1979:2016
