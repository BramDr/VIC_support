...
gva.file1 = "Input/GVA2_Data.csv"
gva.out = "Output/country_GVA_global.csv"
...
# Setup
colnames(gva.data) = c("countryname", "countrycode", "varname", "varcode", 
                        paste0("GvaPGdp.",1960:2018))
gva.data = reshape(data = gva.data, 
