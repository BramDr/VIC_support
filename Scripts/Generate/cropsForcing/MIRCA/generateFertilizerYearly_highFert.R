...
out.dir <- "../../../../Data/VIC/Forcing/global/fertilizer_yearly_highFert/fertilizer_yearly_highFert_"
years <- 1979:2016
...
for (z in 1:length(years)) {
  ...
  for (i in 1:nrow(crops)) {
    ...
    ncvar_put(nc, var.N_amount, fert.n.fill[, , i, z] * 1.25, start = c(1, 1, i, 1, 1), count = c(-1, -1, 1, -1, -1))
