...
fert.n.file <- "./Saves/fertilizerN_extended_2100_5min_Indus.RDS"
fert.p.file <- "./Saves/fertilizerP_extended_2100_5min_Indus.RDS"
fert.k.file <- "./Saves/fertilizerK_extended_2100_5min_Indus.RDS"
carbon.file <- "./Saves/carbon_crops_5min_Indus.RDS"
ph.file <- "./Saves/ph_crops_5min_Indus.RDS"

crop.out <- "../../../Data/VIC/Parameters/Indus_5min/single/extended_2100/crop_params_Indus.nc"
