...
fert.n.file <- "./Saves/fertilizerN_extended_2050_5min_Indus.RDS"
fert.p.file <- "./Saves/fertilizerP_extended_2050_5min_Indus.RDS"
fert.k.file <- "./Saves/fertilizerK_extended_2050_5min_Indus.RDS"
carbon.file <- "./Saves/carbon_crops_5min_Indus.RDS"
ph.file <- "./Saves/ph_crops_5min_Indus.RDS"

crop.out <- "../../../Data/VIC/Parameters/Indus_5min/single/extended_2050/crop_params_Indus.nc"
...
for (i in 1:nrow(crops)) {
  ...
  crop.out.tmp <- gsub(x = crop.out, pattern = "crop_params_", replacement = paste0("crop_params_", crops$name[i], "_", crops$water[i], "_", crops$season[i], "_"))
  ...
  ncvar_put(nc = nc, varid = var.mineralization_period, vals = period.filled)
