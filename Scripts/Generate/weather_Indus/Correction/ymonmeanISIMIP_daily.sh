...
for sub_dir in $sub_dirs; do
  ...
  force_dirs="../Disaggregated_daily/pr_daily_"$sub_dir"_historical/ ../Disaggregated_daily/tas_daily_"$sub_dir"_historical/ ../Disaggregated_daily/lwdown_daily_"$sub_dir"_historical/ ../Disaggregated_daily/swdown_daily_"$sub_dir"_historical/ ../Converted_daily/vp_daily_"$sub_dir"_historical/ ../Disaggregated_daily/psurf_daily_"$sub_dir"_historical/ ../Disaggregated_daily/wind10_daily_"$sub_dir"_historical/"
  force_dirs="../Disaggregated_daily/pr_daily_"$sub_dir"_historical/ ../Disaggregated_daily/tas_daily_"$sub_dir"_historical/ ../Disaggregated_daily/lwdown_daily_"$sub_dir"_historical/ ../Disaggregated_daily/swdown_daily_"$sub_dir"_historical/"
