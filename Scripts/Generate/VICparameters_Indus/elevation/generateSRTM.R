...
elevation.file = "./Saves/elevation_5min_Indus.RDS"
elev.file = "./Saves/elev_5min_Indus.RDS"
nelev.file = "./Saves/Nelev_5min_Indus.RDS"
areafract.file = "./Saves/AreaFract_5min_Indus.RDS"
...
area.sum = apply(X = areafract, MARGIN = c(1,2), FUN = sum)
areafract.tmp = areafract[,,1]
areafract.tmp[area.sum == 0] = 1
areafract[,,1] = areafract.tmp
