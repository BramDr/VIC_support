...
avg.t.file = "../../../../Data/Transformed/Parameters/avgT_5min_Indus.RDS"
annual.prec.file = "../../../../Data/Transformed/Parameters/annualPrec_5min_Indus.RDS"

vic.orig <- "../../../../Data/Primary/VIC/VIC_params_global.nc"
vic.out <- "../../../../Data/VIC/Parameters/Indus_5min/miscellaneous_params_Vliet_Indus.nc"
