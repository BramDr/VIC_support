...
veg.file <- "../../../Data/VIC/Parameters/Indus_5min/vegetation_params_Modis_Indus.nc"
co2.file <- "../../../Data/VIC/Parameters/Indus_5min/co2_params_Modis_Indus.nc"
soil.file <- "../../../Data/VIC/Parameters/Indus_5min/soil_params_Saxton_Indus.nc"
out.file <- "../../../Data/VIC/Parameters/Indus_5min/VIC_params_Modis_Indus.nc"
