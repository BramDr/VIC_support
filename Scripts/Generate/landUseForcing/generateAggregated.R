...
# Input
Cv.monthly.file = "Aggregated/Saves/Cv_monthly_30min_global.RDS"
out.file = "../../../Data/VIC/Forcing/global/coverage_monthly_MIRCAaggregated/coverage_monthly_MIRCAaggregated.nc"
