...
soil.file <- "../../../../Data/Primary/FACE/Yang2006/Shizukuishi_FACE_98_00/Crop_soil_Shizukuishi_98_00_elevated.xlsx"
global.file <- "../../../../Data/Transformed/Soil/ISRIC/ph_30min_global.RDS"
soil.out <- "./Saves/soil_Shizukuishi.RDS"
...
ocar = c(soil$TC, NA, NA) # g[C]/kg[soil]
