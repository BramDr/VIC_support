...
depth.file <- "../../../../Data/Transformed/Parameters/depth_Lin15min_30min_global.RDS"
quartz.file <- "../../../../Data/Transformed/Parameters/soilQuartz_Lin15min_30min_global.RDS"
expt.file <- "../../../../Data/Transformed/Parameters/soilExpt_Lin15min_30min_global.RDS"
ksat.file <- "../../../../Data/Transformed/Parameters/soilKsat_Lin15min_30min_global.RDS"
bulk.dens.file <- "../../../../Data/Transformed/Parameters/soilBulkDensity_Lin15min_30min_global.RDS"
Wcr.file <- "../../../../Data/Transformed/Parameters/soilWcr_Lin15min_30min_global.RDS"
Wpwp.file <- "../../../../Data/Transformed/Parameters/soilWp_Lin15min_30min_global.RDS"
bubble.file <- "../../../../Data/Transformed/Parameters/soilBubble_Lin15min_30min_global.RDS"
soil.dens.file <- "../../../../Data/Transformed/Parameters/soilSoilDensity_Lin15min_30min_global.RDS"
resid.moist.file <- "../../../../Data/Transformed/Parameters/soilResidual_Lin15min_30min_global.RDS"
mask.file <- "../../../../Data/Primary/VIC/domain_global.nc"
vic.orig <- "../../../../Data/Primary/VIC/VIC_params_global.nc"
vic.out <- "../../../../Data/VIC/Parameters/global/soil_params_Lin_global.nc"
...
# Calculate
Nlayer <- apply(X = expt, MARGIN = c(1, 2), FUN = function(x) {
  sum(x > 0)
})
...
max.moist <- (1 - bulk.dens.fill / soil.dens.fill) * 1000 * depth.fill
