...
vic.out <- "../../../../Data/VIC/Parameters/global/co2_params_MIRCAhybrid_global.nc"
...
bco2.adj = array(NA, dim = c(dim(bco2)[1:2], dim(bco2)[3] + 9))
for(i in 1:10) {
  bco2.adj[,,i] = bco2[,,i]
}
bco2.adj[,,11:20] = bco2[,,11]
bco2.adj[,,21] = bco2[,,12]
