...
vic.out <- "../../../../Data/VIC/Parameters/global/co2_params_MIRCAaggregated_global.nc"
...
bco2.adj = array(NA, dim = c(dim(bco2)[1:2], dim(bco2)[3] + 2))
for(i in 1:10) {
  bco2.adj[,,i] = bco2[,,i]
}
bco2.adj[,,11:13] = bco2[,,11]
bco2.adj[,,14] = bco2[,,12]
