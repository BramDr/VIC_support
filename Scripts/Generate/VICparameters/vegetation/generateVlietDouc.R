...
rarc.file <- "../../../../Data/Transformed/Parameters/vegetationRarc_NijssenDouc120min_30min_global.RDS"
rmin.file <- "../../../../Data/Transformed/Parameters/vegetationRmin_NijssenDouc120min_30min_global.RDS"
...
vic.out <- "../../../../Data/VIC/Parameters/global/vegetation_params_VlietDouc_global.nc"
