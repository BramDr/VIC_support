...
cv.file <- "../../../../Data/Transformed/Parameters/cv_Lin15min_30min_global.RDS"

root.fract.file <- "../../../../Data/Transformed/Parameters/rootFract_Lin15min_30min_global.RDS"
root.depth.file <- "../../../../Data/Transformed/Parameters/rootDepth_Lin15min_30min_global.RDS"

lai.file <- "../../../../Data/Transformed/Parameters/LAI_Lin15min_30min_global.RDS"
displacement.file <- "../../../../Data/Transformed/Parameters/displacement_Lin15min_30min_global.RDS"
veg.rough.file <- "../../../../Data/Transformed/Parameters/vegRough_Lin15min_30min_global.RDS"
albedo.file <- "../../../../Data/Transformed/Parameters/albedo_Lin15min_30min_global.RDS"

overstory.file <- "../../../../Data/Transformed/Parameters/vegetationOverstory_Lin15min_30min_global.RDS"
rarc.file <- "../../../../Data/Transformed/Parameters/vegetationRarc_Lin15min_30min_global.RDS"
rmin.file <- "../../../../Data/Transformed/Parameters/vegetationRmin_Lin15min_30min_global.RDS"
rgl.file <- "../../../../Data/Transformed/Parameters/vegetationRgl_Lin15min_30min_global.RDS"
sol.atten.file <- "../../../../Data/Transformed/Parameters/vegetationSolarAttenuation_Lin15min_30min_global.RDS"
wind.atten.file <- "../../../../Data/Transformed/Parameters/vegetationWindAttenuation_Lin15min_30min_global.RDS"
trunk.ratio.file <- "../../../../Data/Transformed/Parameters/vegetationTrunkRatio_Lin15min_30min_global.RDS"
wind.h.file <- "../../../../Data/Transformed/Parameters/vegetationWindh_Lin15min_30min_global.RDS"

mask.file <- "../../../../Data/Primary/VIC/domain_global.nc"
vic.orig <- "../../../../Data/Primary/VIC/VIC_params_global.nc"
vic.out <- "../../../../Data/VIC/Parameters/global/vegetation_params_Lin_global.nc"
