...
rarc.file <- "../../../../Data/Transformed/Parameters/vegetationRarc_Vliet30min_30min_global.RDS"
rmin.file <- "../../../../Data/Transformed/Parameters/vegetationRmin_Vliet30min_30min_global.RDS"
...
vic.out <- "../../../../Data/VIC/Parameters/global/vegetation_params_Vliet_global.nc"
