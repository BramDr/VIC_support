...
Cv.file <- "Saves/cellParametersUniformAlt_Cv.csv"
fixed.file <- "Saves/cellParametersUniformAlt_fixed.csv"
fcanopy.file <- "Saves/cellParametersUniformAlt_fcanopy.csv"
albedo.file <- "Saves/cellParametersUniformAlt_albedo.csv"
LAI.file <- "Saves/cellParametersUniformAlt_LAI.csv"
veg_rough.file <- "Saves/cellParametersUniformAlt_vegRough.csv"
displacement.file <- "Saves/cellParametersUniformAlt_displacement.csv"
paddy.out <- "Saves/parametersUniformAltPaddy_30min_global.RDS"
irr.out <- "Saves/parametersUniformAltIrrigated_30min_global.RDS"
rain.out <- "Saves/parametersUniformAltRainfed_30min_global.RDS"
