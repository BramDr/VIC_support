...
vegetation.out <- "../../../../Data/VIC/Parameters/global/vegetation_params_MIRCAhybridUniformAlt_global.nc"
...
for(i in 1:nrow(split)){
  parameter.out.tmp = gsub(x = parameter.file, pattern = "parametersUniform_", 
