...
fertilizer.file = "./Fertilizer/Saves/fertilizer_Shizukuishi.RDS"
irrigation.file = "./Irrigation/Saves/irrigation_Shizukuishi.RDS"
initial.file = "./Initialization/Saves/initial_Shizukuishi.RDS"
tsum.file = "./TSUM/Saves/tsum_Shizukuishi.RDS"
phenology.file = "./Phenology/saves/phenology_Shizukuishi.RDS"
...
crop.param.out = "../../../Data/WOFOST/Parameters/Crop/FACE/Shizukuishi/crop_params_Shizukuishi.txt"
management.param.out = "../../../Data/WOFOST/Parameters/Management/FACE/Shizukuishi/management_params_Shizukuishi.txt"
param.out = "../../../Data/VIC/Parameters/FACE/Shizukuishi/wofost_params_Shizukuishi.txt"
...
for(treatment in tsum$treatment){
   crop.param.out.tmp = gsub(x = crop.param.out, pattern = "_Shizukuishi", replacement = paste0("_", treatment, "_Shizukuishi"))
   management.param.out.tmp = gsub(x = management.param.out, pattern = "_Shizukuishi", replacement = paste0("_", treatment, "_Shizukuishi"))
   param.out.tmp = gsub(x = param.out, pattern = "_Shizukuishi", replacement = paste0("_", treatment, "_Shizukuishi"))
   ...
   param.tmp = param
   param.tmp = gsub(x = param.tmp, pattern = "global/", replacement = "FACE/Shizukuishi/")
