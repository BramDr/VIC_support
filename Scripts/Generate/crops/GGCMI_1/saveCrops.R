...
fertilizer = c("wheat", "maize", "soybean", "rice", NA, "sugarcane", "sorghum", "millet",
			   "rapeseed", "sugarbeet", NA, "cassava", NA, "sunflower",
			   "groundnut", NA, "cotton", "potato")
