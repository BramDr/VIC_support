...
conf.out = "../../../../Data/VIC/Parameters/global/WOFOST_SA/wofost_params_global.txt"
...
for (i in 1:nrow(crops)){
  ...
  for(z in 1:noptions){
    ...
    text = c()
    conf.out.tmp = gsub(x = conf.out, pattern = "wofost_params_", replacement = paste0("wofost_params_", crops$name[i], "_", crops$water[i], "_", crops$season[i], "_", z, "_"))
