...
# Input
coverage.file <- "../VICparameters_Indus/agriculture_simple/Saves/coverage_adjusted_monthly_5min_Indus.RDS"
out.file <- "../../../Data/VIC/Forcing/Indus_5min/coverage_monthly_MIRCA_simple/coverage_monthly_MIRCA_simple.nc"
resolution = 1 / 12
