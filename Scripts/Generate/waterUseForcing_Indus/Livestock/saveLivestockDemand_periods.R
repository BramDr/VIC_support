...
meteo.file <- "../../../../Data/Transformed/ERA5/tas_daily_ERA5adj_ymonmean_1980_2010.nc"
area.file <- "../../../../Data/Transformed/Routing/area_5min_Indus.RDS"
liv.out <- "Saves/livestockDemand_periods_5min_Indus.RDS"
...
for(i in 1:nrow(periods)){
  ...
  with.tot.data[[period.pattern]] = with.tot
}

dir.create(dirname(liv.out))
saveRDS(with.tot.data, liv.out)
