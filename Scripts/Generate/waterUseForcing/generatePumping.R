...
out.dir <- "../../../Data/VIC/Forcing/global/pumpCap_yearly/pumpCap_yearly_"
years <- 1960:2016
...
pumping.tot[, , (dim(pumping)[3] + 1):dim(pumping.tot)[3]] <- pumping[, , dim(pumping)[3]]
...
for (z in 1:length(years)) {
  ...
  ncvar_put(nc, var$name, pumping.tot[, , z])
  nc_close(nc)
}
