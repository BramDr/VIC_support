...
# Input
cells.file <- "../../../../Data/Transformed/Country/country_30min_cellfractions.RDS"
iso.file <- "../../../../Data/Primary/ISO3166/ISO3166_dev.csv"
ind.file <- "../Industrial/Saves/industrialDemand_30min_global.RDS"
ene.file <- "../Energy/Saves/energyDemand_30min_global.RDS"
man.out <- "Saves/manufacturingDemand_30min_global.RDS"
ene.out <- "Saves/energyDemand_30min_global.RDS"
years <- 1979:2016
...
country.ind <- data.frame(
  Country_number = rep(ids.c, each = length(years) * 12),
