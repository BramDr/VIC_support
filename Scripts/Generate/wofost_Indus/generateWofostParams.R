...
crop.dir <- "../../../Data/WOFOST/Parameters/Crop/Indus_5min/"
management.dir <- "../../../Data/WOFOST/Parameters/Management/Indus_5min/"
conf.out <- "../../../Data/VIC/Parameters/Indus_5min/wofost_params_MircaModis_Indus.txt"
