...
phenology.file = "../wofost_FACE/Phenology/Saves/phenology_Shizukuishi.RDS"
options.file = "./options.template.txt"
options.out = "../../../Data/VIC/Configuration/FACE/Shizukuishi/options_Shizukuishi.txt"
...
for(treatment in unique(phenology$treatment)){
   ...
   options.text = gsub(x = options.text, pattern = "DOMAIN_TEMPLATE", replacement = "Shizukuishi")
   ...
   options.text[param.line] = paste0("PARAMETERS",
                                     "\t",
                                     paste0("/home/bram/Data/VIC/Parameters/FACE/Shizukuishi/VIC_params_Shizukuishi.nc"))
