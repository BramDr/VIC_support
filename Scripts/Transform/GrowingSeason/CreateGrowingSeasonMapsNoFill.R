...
grow.season.out = "../../../Data/Transformed/GrowingSeason/growingSeasonNoFill_30min_global.RDS"

# Load
sage.files = list.files(path = sage.dir, pattern = ".calendar.nc", full.names = T)
