...
# Input
veg.file <- "../../../Data/Primary/Lin2019/veglib.dat"
albedo.out <- "../../../Data/Transformed/Parameters/albedo_Lin15min_30min_global.RDS"
displacement.out <- "../../../Data/Transformed/Parameters/displacement_Lin15min_30min_global.RDS"
veg_rough.out <- "../../../Data/Transformed/Parameters/vegRough_Lin15min_30min_global.RDS"
