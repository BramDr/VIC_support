...
tsum.file = "./TSUM/Saves/tsum_point.RDS"
...
crop.param.out = "../../../../Data/WOFOST/Parameters/Crop/FACE/crop_params_point.txt"
management.param.out = "../../../../Data/WOFOST/Parameters/Crop/FACE/management_params_point.txt"
param.out = "../../../../Data/WOFOST/Parameters/Crop/FACE/wofost_params_point.txt"
...
for(treatment in tsum$treatment){
   crop.param.out.tmp = gsub(x = crop.param.out, pattern = "_point", replacement = paste0("_", treatment, "_point"))
   management.param.out.tmp = gsub(x = management.param.out, pattern = "_point", replacement = paste0("_", treatment, "_point"))
   param.out.tmp = gsub(x = param.out, pattern = "_point", replacement = paste0("_", treatment, "_point"))
