...
weather.dir <- "../../Weather"
tsum.out <- "./Saves/tsum_point.RDS"

# Load
phenology = readRDS(phenology.file)
weather.files <- list.files(path = weather.dir, pattern = "point.*nc", full.names = T)
...
## Get tsum
tsums = data.frame(treatment = phenology$treatment, tsum1 = NA, tsum2 = NA)
