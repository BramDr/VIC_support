...
fertilizer.file = "./Fertilizer/Saves/fertilizer_observed.RDS"
irrigation.file = "./Irrigation/Saves/irrigation_observed.RDS"
tsum.file = "./TSUM/Saves/tsum_observed.RDS"
phenology.file = "./Phenology/saves/phenology_observed.RDS"
...
crop.param.out = "../../../../Data/WOFOST/Parameters/Crop/FACE/crop_params_observed.txt"
management.param.out = "../../../../Data/WOFOST/Parameters/Crop/FACE/management_params_observed.txt"
param.out = "../../../../Data/WOFOST/Parameters/Crop/FACE/wofost_params_observed.txt"
...
for(treatment in tsum$treatment){
   crop.param.out.tmp = gsub(x = crop.param.out, pattern = "_observed", replacement = paste0("_", treatment, "_observed"))
   management.param.out.tmp = gsub(x = management.param.out, pattern = "_observed", replacement = paste0("_", treatment, "_observed"))
   param.out.tmp = gsub(x = param.out, pattern = "_observed", replacement = paste0("_", treatment, "_observed"))
   ...
   param.tmp = param
   param.tmp = gsub(x = param.tmp, pattern = "global/", replacement = "FACE/")
