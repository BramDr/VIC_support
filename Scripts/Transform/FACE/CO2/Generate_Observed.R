...
# Input
co2.file <- "./Saves/co2_observed.RDS"
out.dir <- "../../../../Data/VIC/Forcing/FACE/co2_yearly_observed_"
years <- 1992:1997
...
for(treatment in co2$treatment){
  ...
  for (z in 1:length(years)) {
    ...
    out.file = gsub(out.file, pattern = "_observed", replacement = paste0("_", treatment, "_observed"))
