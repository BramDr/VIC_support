...
options.out = "../../../../Data/VIC/Configuration/FACE/options_observed.txt"
...
for(treatment in phenology$treatment){
   options.out.tmp = gsub(x = options.out, pattern = "_observed", replacement = paste0("_", treatment, "_observed"))
