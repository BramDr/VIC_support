...
quartz.file <- "./Out_observed/quartz_observed.RDS"
expt.file <- "./Out_observed/expt_observed.RDS"
ksat.file <- "./Out_observed/ksat_observed.RDS"
bulk.dens.file <- "./Out_observed/bulk_dens_observed.RDS"
Wcr.file <- "./Out_observed/Wcr_observed.RDS"
Wpwp.file <- "./Out_observed/Wpwp_observed.RDS"
bubble.file <- "./Out_observed/bubble_observed.RDS"
soil.dens.file <- "./Out_observed/soil_dens_observed.RDS"
resid.moist.file <- "./Out_observed/resid_moist_observed.RDS"
vic.orig <- "../../../../Data/Primary/VIC/VIC_params_global.nc"
vic.out <- "./soil_params_observed.nc"
...
Wpwp.fill[!is.na(Wpwp.fill) & Wpwp.fill < resid.moist.fill / porosity] <- 
  resid.moist.fill[!is.na(Wpwp.fill) & Wpwp.fill < resid.moist.fill / porosity] / 
  porosity[!is.na(Wpwp.fill) & Wpwp.fill < resid.moist.fill / porosity] - 1e-6
Wcr.fill[!is.na(Wcr.fill) & Wcr.fill < Wpwp.fill] <- 
  Wpwp.fill[!is.na(Wcr.fill) & Wcr.fill < Wpwp.fill] + 1e-6
