...
Wfc.out <- "../../../../Data/Transformed/Soil/ISRIC/Wfc_5min_Indus.RDS"
...
max.moist.out <- "../../../../Data/Transformed/Soil/ISRIC/max_moist_5min_Indus.RDS"
...
# Fill spatial
na.map = is.na(array(0, dim = dim(clay)[1:2]))
