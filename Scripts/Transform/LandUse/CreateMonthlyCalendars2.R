...
kc.file <- "../../../Data/Transformed/LandUse/subcropCalendar_development_30min_global.csv"
albedo.out <- "../../../Data/Transformed/LandUse/subcropCalendar_albedo_30min_global.csv"
height.out <- "../../../Data/Transformed/LandUse/subcropCalendar_height_30min_global.csv"
LAI.out <- "../../../Data/Transformed/LandUse/subcropCalendar_LAI2_30min_global.csv"
veg_rough.out <- "../../../Data/Transformed/LandUse/subcropCalendar_vegRough_30min_global.csv"
displacement.out <- "../../../Data/Transformed/LandUse/subcropCalendar_displacement_30min_global.csv"
