...
pop.file1 <- "../../../Data/Primary/MaddisonProject/mpd2018.xlsx"
pop.file2 <- "../../../Data/Primary/MaddisonProject/pwt90.xlsx"
pop.file3 <- "../../../Data/Primary/WorldBank/Population_Data.csv"
pop.out <- "../../../Data/Transformed/Population/population_country.csv"
