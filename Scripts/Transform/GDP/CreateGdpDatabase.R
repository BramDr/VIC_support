...
gdp.file1 <- "../../../Data/Primary/MaddisonProject/mpd2018.xlsx"
gdp.file2 <- "../../../Data/Primary/MaddisonProject/pwt90.xlsx"
gdp.file3 <- "../../../Data/Primary/WorldBank/GDP2011_Data.csv"
gdp.out <- "../../../Data/Transformed/GDP/GDP_country.csv"
...
colnames(gdp.data3.gdppc) <- c(
  "countryname", "countrycode", "varname", "varcode",
  paste0("GdpPc.", 1960:2018)
)
gdp.data3.gdppc <- reshape(
  data = gdp.data3.gdppc,
...
colnames(gdp.data3.gdp) <- c(
  "countryname", "countrycode", "varname", "varcode",
  paste0("Gdp.", 1960:2018)
)
gdp.data3.gdp <- reshape(
  data = gdp.data3.gdp,
